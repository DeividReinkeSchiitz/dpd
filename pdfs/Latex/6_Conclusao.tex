...
\begin{enumerate}
  ...
  \item Aprimorar e calibrar o GRASP antes de uma nova avaliação da variante híbrida, considerando um número maior de iterações, diferentes valores de $\alpha$, busca local, múltiplas construções com sementes controladas e estratégias reativas. A redução de tempo, gap e nós restantes observada em relação ao GRASP isolado indica que essa integração é uma direção promissora.
