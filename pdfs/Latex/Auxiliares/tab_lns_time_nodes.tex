...
\begin{table}[htbp]
\centering
\caption{Número de nós restantes para diferentes limites de tempo do sub-MIP. Ajuste dos demais parâmetros: 75\% de destruição, ordenação crescente, limite global = 400s.}
