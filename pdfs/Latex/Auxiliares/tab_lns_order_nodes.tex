...
\begin{table}[htbp]
\centering
\caption{Número de nós restantes comparando ordenação crescente e decrescente. Ajuste dos demais parâmetros: 75\% de destruição, tempo LNS = 30s, limite global = 400s.}
