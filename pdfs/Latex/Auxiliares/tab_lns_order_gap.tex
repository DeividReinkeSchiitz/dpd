...
\begin{table}[htbp]
\centering
\caption{Gap de otimalidade (\%) comparando ordenação crescente e decrescente. Combinação de parâmetros mantida fixa: 75\% de destruição, tempo LNS = 30s, limite global = 400s.}
