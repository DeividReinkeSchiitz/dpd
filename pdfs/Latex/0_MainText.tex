...
\membrodabancaA{Prof. Dr. Francisco Eloi Soares de Araújo}
\membrodabancaB{Prof. Dr. Fábio Henrique Viduani Martinez}
\instituicao{%
...
\hypersetup{
	    ...
	    pdfcreator={LaTeX with abnTeX2},
			pdfkeywords={Distribuição de Disciplinas, Programação Linear Inteira, Matheurística, Large Neighborhood Search, SCIP},
