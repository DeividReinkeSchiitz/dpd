...
\definecolor{chartSteel}{HTML}{4472C4}      % Azul aço - B\&B puro (geral)
...
% As obras são de autores distintos com o mesmo sobrenome; as iniciais
% evitam que o estilo as trate como múltiplas obras de um único autor.
\bibciteEXPL{silva2024matheuristica_mochila}{SILVA, P. P. A. P.}
\bibciteIMPL{silva2024matheuristica_mochila}{Silva, P. P. A. P.}
\bibciteYEAR{silva2024matheuristica_mochila}{2024}
\bibciteEXPL{silva2024abordagem_exata_dpd}{SILVA, L. S.}
\bibciteIMPL{silva2024abordagem_exata_dpd}{Silva, L. S.}
\bibciteYEAR{silva2024abordagem_exata_dpd}{2024}
